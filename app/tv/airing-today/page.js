...
const page = () => {
  ...
  const getPosts = async () => {
    try {
      ...
      const { data } = await axios.get(`tv/airing_today?api_key=ae62e0e1e676b510dc1c7f7b9a1d9b34&_start=${posts.length}&page=${page}`);
  ...
  return (
    <div className='container2 mt-8'>
        <h1>Airing-today</h1>
        <div className='cards  mx-20 mt-5'>
          <div className='card '>
